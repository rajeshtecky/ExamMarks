...
input_dir = r'D:\rajesh\examreports\test'  # Use raw string to avoid escape sequence issues
output_dir = r'D:\rajesh\examreports\output'  # Use raw string to avoid escape sequence issues
    ...
    if filename.endswith('.xlsx'):
        ...
        if header_row_index is not None:
            ...
            for section in sections:
                ...
                excel_file = os.path.join(file_output_dir, f'{section}.xlsx')
                wb.save(excel_file)

        print(f"Processed file saved in: {file_output_dir}")
